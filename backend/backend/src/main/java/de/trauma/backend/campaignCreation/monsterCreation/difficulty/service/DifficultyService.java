package de.trauma.backend.campaignCreation.monsterCreation.difficulty.service;

import de.trauma.backend.campaignCreation.monsterCreation.difficulty.domain.Difficulty;
import de.trauma.backend.campaignCreation.monsterCreation.difficulty.exceptions.DifficultyNotFoundException;
import de.trauma.backend.campaignCreation.monsterCreation.difficulty.repository.DifficultyEntity;
import de.trauma.backend.campaignCreation.monsterCreation.difficulty.repository.DifficultyRepository;
