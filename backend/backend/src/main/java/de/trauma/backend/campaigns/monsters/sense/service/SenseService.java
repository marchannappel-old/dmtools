package de.trauma.backend.campaigns.monsters.sense.service;

import de.trauma.backend.campaigns.monsters.sense.domain.Sense;
import de.trauma.backend.campaigns.monsters.sense.exceptions.SenseNotFoundException;
import de.trauma.backend.campaigns.monsters.sense.repository.SenseEntity;
import de.trauma.backend.campaigns.monsters.sense.repository.SenseRepository;
