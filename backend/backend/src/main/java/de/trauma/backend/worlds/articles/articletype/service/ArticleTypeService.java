package de.trauma.backend.worlds.articles.articletype.service;

import de.trauma.backend.worlds.articles.articletype.domain.ArticleType;
import de.trauma.backend.worlds.articles.articletype.exceptions.ArticleTypeNotFoundException;
import de.trauma.backend.worlds.articles.articletype.repository.ArticleTypeEntity;
import de.trauma.backend.worlds.articles.articletype.repository.ArticleTypeRepository;
