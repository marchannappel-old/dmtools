package de.trauma.backend.campaigns.monsterCreation.sense.service;

import de.trauma.backend.campaigns.monsterCreation.sense.domain.Sense;
import de.trauma.backend.campaigns.monsterCreation.sense.exceptions.SenseNotFoundException;
import de.trauma.backend.campaigns.monsterCreation.sense.repository.SenseEntity;
import de.trauma.backend.campaigns.monsterCreation.sense.repository.SenseRepository;
