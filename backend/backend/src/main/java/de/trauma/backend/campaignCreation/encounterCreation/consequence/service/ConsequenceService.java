package de.trauma.backend.campaignCreation.encounterCreation.consequence.service;

import de.trauma.backend.campaignCreation.encounterCreation.consequence.domain.Consequence;
import de.trauma.backend.campaignCreation.encounterCreation.consequence.exceptions.ConsequenceNotFoundException;
import de.trauma.backend.campaignCreation.encounterCreation.consequence.repository.ConsequenceEntity;
import de.trauma.backend.campaignCreation.encounterCreation.consequence.repository.ConsequenceRepository;
