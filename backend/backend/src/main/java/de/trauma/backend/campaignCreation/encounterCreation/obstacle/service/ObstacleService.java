package de.trauma.backend.campaignCreation.encounterCreation.obstacle.service;

import de.trauma.backend.campaignCreation.encounterCreation.obstacle.domain.Obstacle;
import de.trauma.backend.campaignCreation.encounterCreation.obstacle.exceptions.ObstacleNotFoundException;
import de.trauma.backend.campaignCreation.encounterCreation.obstacle.repository.ObstacleEntity;
import de.trauma.backend.campaignCreation.encounterCreation.obstacle.repository.ObstacleRepository;
